...
class Halftone(object):
    ...
    def halftone_error_diffusion_1bit(self, img, method="jjn"):
        return halftone_error_diffusion_1bit(img, method)
...
def logarithmic_quantizer_Nbit(img, N):
    ...
    quantized_image = np.round(scale_factor*np.log2(img+1))
